...
// Always show the account chooser rather than silently reusing a cached
// Google session -- avoids a separate class of "seems to do nothing"
// reports when a browser is signed into multiple Google accounts.
